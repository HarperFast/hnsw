...
#[napi]
impl Plane {
    /// Create a new plane file. `layer0Cap` is the per-slot layer-0 neighbour capacity: 32 (2M for
    /// M 16) is the measured size/recall trade (DESIGN.md §10). `maxNodes` bounds the sparse

...
/// holds up to `9/8 * ceil(nodes / 64) * 8` bytes of visited bitmap plus a bounded journal (see
/// `SearchScratch`): 200M nodes is 25-29 MB per scratch, ~7 GB across 256 in flight.
